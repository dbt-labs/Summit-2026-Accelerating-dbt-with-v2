with
    ...
    stores as (
        ...
        select store_id, store_location, tax_rate, opened_at
    ...
    daily_rollup as (
        ...
        select
            ...
            datediff(
                'day', orders.ordered_at, stores.opened_at
            ) as days_since_store_open

        from orders
        left join stores on orders.store_id = stores.store_id

        group by orders.store_id, stores.store_location, 
        stores.tax_rate, order_date, days_since_store_open
