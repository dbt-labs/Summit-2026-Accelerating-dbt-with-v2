...
daily_rollup as (
    ...
    select
        ...
        max(stores.tax_rate) as tax_rate,
        ...
        round(daily_order_total / orders_count,2) as avg_order_total,

        max(datediff('day', stores.opened_at, orders.ordered_at)) as days_since_store_open
