with
    orders as (
        ...
        select
            order_id, customer_id, store_id, ordered_at, subtotal, tax_paid, order_total
    ...
    joined as (
        ...
        select
            ...
            cast(orders.subtotal * stores.tax_rate as numeric(16, 2)) as expected_tax,
            cast(
                orders.tax_paid - (orders.subtotal * stores.tax_rate) as numeric(16, 2)
            ) as tax_delta
