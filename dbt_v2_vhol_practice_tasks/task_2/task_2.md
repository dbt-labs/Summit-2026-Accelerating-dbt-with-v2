...
Locate the starter SQL file in the task_2 folder.
...
Modify the SQL so the final model produces a clean, daily store-level mart with:
...
- daily_order_total is consistent with subtotal plus tax
